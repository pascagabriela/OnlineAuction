            ...
            <MDBCard className='mx-5 mb-5 p-5 shadow-5' style={{marginTop: '-100px', background: 'hsla(0, 0%, 100%, 0.8)', backdropFilter: 'blur(30px)'}}>
                <MDBCard className='text-black' >
                    <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto '>
                        ...
                        <MDBRow>
                            <MDBCol>
                                <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-black-50' label='First name' type='text' id='formControlLg' size="lg"/>
                            </MDBCol>
                            <MDBCol>
                                <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-black-50' label='Last name' type='text' id='formControlLg' size="lg"/>
                            </MDBCol>
                        </MDBRow>
                        <MDBRow>
                            <MDBCol>
                            ...
                            <MDBCol>
                                <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-black-50' label='Phone number' id='formControlLg' size="lg"/>
                            </MDBCol>
                        </MDBRow>
                        <MDBInput  wrapperClass='mb-4 mx-5 w-100' labelClass='text-black-50' label='Password' id='formControlLg' type='password' size="lg"/>
                        <MDBInput  wrapperClass='mb-4 mx-5 w-100' labelClass='text-black-50' label='Confirm password' id='formControlLg' type='password' size="lg"/>
                        </MDBContainer>
                            <MDBBtn href='/dashboard' outline className='mx-2 px-5 text-blue' size='lg'>
                            Sign up
                        </MDBBtn>
